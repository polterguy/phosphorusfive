...
save-file:/test1.txt
  src:x:/../*/_data");
        ...
        public static void test_save_av1 (ApplicationContext context, ActiveEventArgs e)
        {
  ...
  test.save.av1");
        ...
        public static void test_save_av2 (ApplicationContext context, ActiveEventArgs e)
        {
  ...
  foo2:bar2", reader.ReadToEnd ());
        ...
        public static void test_save_av3_1 (ApplicationContext context, ActiveEventArgs e)
        {
            e.Args.Add ("foo1", "bar1");
        }

        [ActiveEvent (Name = "test.save.av3_2", Protection = EventProtection.LambdaClosed)]
        public static void test_save_av3_2 (ApplicationContext context, ActiveEventArgs e)
        {
            e.Args.Add ("foo2", "bar2");
        }
  ...
  foo2:bar2", reader.ReadToEnd ());
        ...
        public static void test_save_av4_1 (ApplicationContext context, ActiveEventArgs e)
        {
            e.Args.Value = "succ";
        }

        [ActiveEvent (Name = "test.save.av4_2", Protection = EventProtection.LambdaClosed)]
        public static void test_save_av4_2 (ApplicationContext context, ActiveEventArgs e)
        {
            e.Args.Value = "ess";
        }
