...
add:x:/..
  src:x:/./-2/0");
        ...
        [ActiveEvent (Name = "set.test1", Protection = EntranceProtection.Lambda)]
...
add:x:/..
  src:x:/./-2");
        ...
        [ActiveEvent (Name = "set.test2", Protection = EntranceProtection.Lambda)]
...
add:x:/..
  src:x:/./-2");
        ...
        [ActiveEvent (Name = "set.test3", Protection = EntranceProtection.Lambda)]
