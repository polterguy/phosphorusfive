...
namespace phosphorus.unittests
{
    ...
    public class MongoDBTests : TestBase
    {
        ...
        public void SetUp ()
        {
            ExecuteLambda (@"p5.mongo.delete:unit_tests
p5.mongo.delete:unit_tests2");
        }

        [Test]
        public void SimpleInsertAndSelect ()
        {
            Node tmp = ExecuteLambda (@"p5.mongo.insert
  unit_tests
    simple_string:howdy world
p5.mongo.select:unit_tests");
...
if:@/../*/""p5.mongo.insert""/0/?node
  !=:@/../*/""p5.mongo.select""/0/result/*/?node
  lambda
