...
namespace pf.lambda
{
    ...
    public static class Lambda
    {
        ...
        /// 
        ///     Besides from that, [lambda.immutable] is identical to [lambda]. See the <see cref="pf.lambda.Lambda.lambda_lambda">[lambda]</see>
        ...
        /// 
        ///     Besides from that, [lambda.copy] is identical to [lambda]. See the <see cref="pf.lambda.Lambda.lambda_lambda">[lambda]</see>
        ///     keyword's documentation, to understand what more features you can use with [lambda.immutable].
        /// </summary>
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
