...
namespace pf.lambda.keywords
{
    ...
    public static class Branching
    {
        ...
        /// 
        ///     Will evaluate some <see cref="pf.lambda.keywords.helpers.Conditions">Condition</see>, and if the condition evaluates 
        ...
        ///     works, see the documentation for <see cref="pf.lambda.keywords.Branching.lambda_if">[if]</see>.
        /// </summary>
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
