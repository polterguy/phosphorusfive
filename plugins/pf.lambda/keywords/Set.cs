...
namespace pf.lambda.keywords
{
    ...
    public static class Set
    {
        ...
        ///     <see cref="pf.lambda.keywords.Append.lambda_append">[append]</see>.
        /// 
        ///     Example;
        /// 
        ///     <pre>_source:foo
        ...
        ///     read the documentation for the <see cref="pf.lambda.keywords.Append.lambda_append">[append]</see> keyword. [set] uses its
