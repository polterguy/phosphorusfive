...
namespace p5.lambda
{
    ...
    public static class While
    {
        ...
        ///     result-set, [while] loops as long as some <see cref="p5.lambda.keywords.helpers.Conditions">Condition</see> is true.
        /// 
        ///     Example;
        /// 
        ///     <pre>_data
        ...
        ///     execution thread, creating a "dead-lock" in your p5.lambda code. To avoid such dead-locks, you must makke sure that your condition
        ...
        ///     <see cref="p5.lambda.keywords.Branching.lambda_if">[if]</see> or 
        ///     <see cref="p5.lambda.keywords.helpers.Conditions">Condition</see>.
        /// </summary>
