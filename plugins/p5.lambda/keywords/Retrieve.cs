...
{
    /// <summary>
    ///     Class wrapping the [retrieve-nodes] keyword in p5.lambda
    /// </summary>
    public static class Retrieve
    {
        /// <summary>
        ///     The [retrieve] keyword, allows you to forward retrieve results of evaluation of its body
        /// </summary>
        /// <param name="context">Application context</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "retrieve", Protection = EventProtection.LambdaClosed)]
        private static void lambda_retrieve_nodes (ApplicationContext context, ActiveEventArgs e)
        {
