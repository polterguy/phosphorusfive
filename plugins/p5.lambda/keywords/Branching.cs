...
namespace p5.lambda.keywords
{
    ...
    public static class Branching
    {
        ...
        [ActiveEvent (Name = "if", Protection = EntranceProtection.Lambda)]
        ...
        /// <param name="context">Application context</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "else-if", Protection = EntranceProtection.Lambda)]
        ...
        /// <param name="context">Application context</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "else", Protection = EntranceProtection.Lambda)]
