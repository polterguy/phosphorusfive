...
namespace p5.lambda.keywords
{
    ...
    public static class Branching
    {
        ...
        ///     condition if your first [if] condition yields false. While the [else] statement, is the default p5.lambda nodes to execute, if
        ...
        private static void lambda_else_if (ApplicationContext context, ActiveEventArgs e)
        {
            ...
            if (e.Args.Parent [0].Name == "__p5_evaluated") {
        ...
        private static void CreateEvaluatedSignal (Node node)
        {
            ...
            if (next != null && (next.Name == "else-if" || next.Name == "else")) {
                node.Parent.Insert (0, new Node ("__p5_evaluated")); // "signal node" inserted
            }
        }
