...
namespace p5.types.types
{
    ...
    public static class DoubleType
    {
        ...
        static void p5_hyperlisp_get_object_value_double (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        static void p5_hyperlisp_get_type_name_System_Double (ApplicationContext context, ActiveEventArgs e)
        {
            e.Args.Value = "double";
        }
    }
