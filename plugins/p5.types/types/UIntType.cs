...
{
    /// <summary>
    ///     Class helps converts from uint to string, and vice versa
    /// </summary>
    public static class UIntType
    {
        /// <summary>
        ///     Creates an uint from its string representation
        /// </summary>
        ...
        static void p5_hyperlisp_get_object_value_int (ApplicationContext context, ActiveEventArgs e)
        {
            if (e.Args.Value is int)
                return;
            e.Args.Value = System.Convert.ToUInt32 (e.Args.Value);
        }
