...
{
    /// <summary>
    ///     Class wrapping the [p5.string.to-lower] keyword in p5 lambda.
    /// </summary>
    public static class ToLower
    {
        /// <summary>
        ///     The [p5.string.to-lower] keyword, allows you to transform all UPPERCASE characters in a string to lowercase
        /// </summary>
