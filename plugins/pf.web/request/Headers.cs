...
namespace phosphorus.web.ui.request
{
    ...
    public static class Headers
    {
        ...
        [ActiveEvent (Name = "pf.web.get-request-header")]
        private static void pf_web_get_request_header (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.list-request-headers")]
        private static void pf_web_list_request_headers (ApplicationContext context, ActiveEventArgs e)
        {
