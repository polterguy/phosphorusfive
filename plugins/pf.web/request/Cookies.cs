...
namespace phosphorus.web.ui.request
{
    ...
    public static class Cookies
    {
        ...
        [ActiveEvent (Name = "pf.web.get-request-cookie")]
        private static void pf_web_get_request_cookie (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.list-request-cookies")]
        private static void pf_web_list_request_cookies (ApplicationContext context, ActiveEventArgs e)
        {
