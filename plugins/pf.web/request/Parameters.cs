...
namespace phosphorus.web.ui.request
{
    ...
    public static class Parameters
    {
        ...
        [ActiveEvent (Name = "pf.web.get-request-parameter")]
        private static void pf_web_get_request_parameter (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.list-request-parameters")]
