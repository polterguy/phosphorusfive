...
namespace phosphorus.web.ui.request
{
    ...
    public static class Request
    {
        ...
        [ActiveEvent (Name = "pf.web.get-request-method")]
        private static void pf_web_get_request_method (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.get-request-body")]
        private static void pf_web_get_request_body (ApplicationContext context, ActiveEventArgs e)
        {
