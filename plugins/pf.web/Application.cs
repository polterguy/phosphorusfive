...
namespace phosphorus.web.ui
{
    ...
    public static class Application
    {
        ...
        [ActiveEvent (Name = "pf.web.set-application")]
        private static void pf_web_set_application (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.get-application")]
        private static void pf_web_get_application (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.list-application")]
