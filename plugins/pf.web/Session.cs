...
namespace phosphorus.web.ui
{
    ...
    public static class Session
    {
        ...
        [ActiveEvent (Name = "pf.web.set-session")]
        private static void pf_web_set_session (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.get-session")]
        private static void pf_web_get_session (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.list-session")]
        private static void pf_web_list_session (ApplicationContext context, ActiveEventArgs e)
        {
