...
namespace phosphorus.web.ui.widgets
{
    ...
    public static class Properties
    {
        ...
        /// 
        ///     Will return all properties/attributes of all widgets requested as the value of the main Active Event node.
        /// </summary>
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.widgets.list-properties")]
        private static void pf_web_widgets_list_properties (ApplicationContext context, ActiveEventArgs e)
        {
            // looping through all widgets
            foreach (var idx in XUtil.Iterate<string> (e.Args, context)) {
        ...
        /*
         * helper for [pf.web.widgets.get-property], creates a return value for one property
         */
