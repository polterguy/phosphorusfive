...
using Void = pf.ajax.widgets.Void;
...
namespace phosphorus.web.ui.widgets
{
    ...
    public static class Widgets
    {
        ...
        /// 
        ///     Active Event is not meant to be raised directly, but through the [pf.web.create-widget] Active Event, since it 
        ...
        /// 
        ///     Any nodes starting with "on", will be assumed to be server-side pf.lambda event handlers. Every time a pf.lambda
        ///     server side event is raised then both [_widget] and [_event] will be passed in to the event handler as root nodes.
        ///     [_widget] is the id of the main widget that is the root widget of the Active Event [pf.web.create-widget], while
        ...
        ///   onclick
        ///     pf.web.widgets.set-property:foo
        ///       class:span-24 prepend-top success
        ///     pf.web.widgets.set-property:bar
        ...
        ///     <see cref="phosphorus.applicationpool.Default.pf_web_widgets_create">[pf.web.create-widget]</see> Active Event.
        /// </summary>
        ...
        ///     created, without an explicitly given id.
        /// 
        ///     If your events ends with "-script", they will however be rendered back to client as JavaScript events without the 
        ///     "-script" parts. If they end with anything else but "-script", but start with "on", they will be assumed to be DOM 
        ///     events, and your node assumed to be containing pf.lambda code, supposed to execute when that DOM event is raised, 
        ///     on the server-side, as pf.lambda code.
        /// 
        ///     Any other nodes, are automatically added as HTML attributes, with their given values, and rendered as such back to 
        ///     the client.
        /// 
