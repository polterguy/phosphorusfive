...
namespace phosphorus.web.ui
{
    ...
    public static class Cache
    {
        ...
        [ActiveEvent (Name = "pf.web.set-cache")]
        private static void pf_web_set_cache (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.get-cache")]
        private static void pf_web_get_cache (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.web.list-cache")]
        private static void pf_web_list_cache (ApplicationContext context, ActiveEventArgs e)
        {
