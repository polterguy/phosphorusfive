...
namespace phosphorus.types
{
    ...
    public static class GetTypeName
    {
        ...
        [ActiveEvent (Name = "pf.hyperlisp.get-type-name.pf.core.Node")]
        private static void pf_hyperlisp_get_type_name_pf_core_Node (ApplicationContext context, ActiveEventArgs e)
        {
            e.Args.Value = "node";
        }
        ...
        /// <param name="context">Application context.</param>
        /// <param name="e">Parameters passed into Active Event.</param>
        [ActiveEvent (Name = "pf.hyperlisp.get-type-name.pf.core.Node+Dna")]
        private static void pf_hyperlisp_get_type_name_pf_core_Node_DNA (ApplicationContext context, ActiveEventArgs e)
        {
            e.Args.Value = "path";
        }
