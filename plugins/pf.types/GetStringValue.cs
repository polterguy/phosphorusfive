...
namespace phosphorus.types
{
    ...
    public static class GetStringValue
    {
        ...
        [ActiveEvent (Name = "pf.hyperlisp.get-string-value.pf.core.Node")]
        private static void pf_hyperlisp_get_string_value_pf_core_Node (ApplicationContext context, ActiveEventArgs e)
        {
