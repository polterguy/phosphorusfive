...
The *[p5.events.delete]* allows you to delete multiple events at the same time though, which the *[create-event]*, without a lambda object does _not_.
...
Also the *[create-event]* and *[p5.events.delete]* have similar protected alias versions.
