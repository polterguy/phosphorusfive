...
namespace p5.web.ui
{
    ...
    public static class Session
    {
        ...
        [ActiveEvent (Name = "set-session", Protection = EventProtection.Lambda)]
        ...
        /// <param name="context">Application context</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "get-session", Protection = EventProtection.Lambda)]
        ...
        /// <param name="context">Application context</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "list-session", Protection = EventProtection.Lambda)]
