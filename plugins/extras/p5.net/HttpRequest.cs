...
namespace p5.net
{
    ...
    public static class HttpRequest
    {
        ...
        /// 
        ///     <pre>p5.net.post:"http://127.0.0.1:8080/web-service-1"
        ///   content
        ///     foo:foo-value
        ///     bar:bar-value</pre>
        /// 
        ...
        /// </summary>
        [ActiveEvent (Name = "p5.net.post-file")]
        [ActiveEvent (Name = "p5.net.put-file")]
        private static void p5_net_post_put_file (ApplicationContext context, ActiveEventArgs e)
        {
            if (e.Args.Value == null)
                return; // nothing to do here
        ...
        /// </summary>
        [ActiveEvent (Name = "p5.net.get-file")]
        private static void p5_net_get_file (ApplicationContext context, ActiveEventArgs e)
        {
            if (e.Args.Value == null)
                return; // nothing to do here
