...
will be default to either 0, 0, _"rest-of-source-image-width"_, _"rest-of-source-image-height"_. If your destination image already exist, it will be silently overwritten.
...
Tranformations will be applied sequentially, in the order they appear in your Hyperlambda, except for resizing that will always be done first.
...
need to supply a **[destination]** argument, and not pass in any **[dest-width]** or **[dest-height]**, at which case, the height and width of your new image, 
...
be somewhere between 15 and 25, depending upon your source image. To understand the difference, realize that this image.
...
If your image contains a lot of the same colors, and big surfaces, then changing from jpeg to png often reduces its size. The opposite is true if your 
image contains a log of different colors, with more _"organic"_ content.
