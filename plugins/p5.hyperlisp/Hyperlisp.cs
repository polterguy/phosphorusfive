...
/// 
///     Hyperlisp is the <em>"syntax"</em> that allows you to create p5.lambda execution trees using a textual-based format. Hyperlisp
...
///     This trait completely separates Phosphorus Five and p5.lambda from all other programming languages, since the syntax for describing
...
///     as p5.lambda. You could probably even <em>"execute"</em> HTML documents if you wish, or JSON, BSON, or any other document format
...
///     used when writing <em>"code"</em>, that we transform into our p5.lambda execution trees.
/// 
...
///     part of your p5.lambda structure. This is done to make sure you can comment your code, without running the risk that your comment starts
///     adding to your bandwidth usage when transmitting p5.lambda code over the wire, using for instance HTTP. Below is an example of a 
///     single-line comment.
/// 
...
///     servers, and storing p5.lambda execution trees, then Hyperlisp is superior in all ways. This can be seen by the fact that the phosphorus.data
...
namespace p5.hyperlisp
{
    ...
    public static class PFHyperlisp
    {
        ...
        /// 
        ///     Active Event will transform the given Hyperlisp to a p5.lambda node structure.
        /// 
        ///     Example;
        /// 
