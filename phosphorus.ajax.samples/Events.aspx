            ...
            <div class="container">
                ...
                <pf:Container
                    ...
                    <pf:Literal
                        ...
                        onmouseout="li2_onmouseout">
                        second element (hover me)
                    </pf:Literal>
                    <pf:Literal
                        runat="server"
                        id="li3"
                        ...
                        onmouseup="li3_onmouseup">
                        third element (click mouse and hold down)
                    </pf:Literal>
                    <pf:Container
                        runat="server"
                        id="li4"
                        ...
                        <pf:Literal
                            ...
                            placeholder="type into me and click tab ..." />
                        <pf:Literal
                            runat="server"
                            id="li4_span"
                            Tag="span" />
                    ...
                    <pf:Literal
                        ...
                        id="li5"
                        Tag="li"
                        onclick="alert('from client side')">
                        fifth element (click me)
                    </pf:Literal>
                </pf:Container>
                <p>
                    the above example shows a container widget with a couple of child widgets rendered as a list, each handling different types of 
                ...
                <p>
                    legal characters for a .net method are a-z, A-Z, 0-9 and _
                </p>
                <p>
                    this allows you to easily create both javascript onxxx output, while at the same time wire up .net methods on the server side
