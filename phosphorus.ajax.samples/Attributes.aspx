    ...
    <body>
        <form id="form1" runat="server" autocomplete="off">
            <div class="container">
                ...
                <p>this example shows you how you can modify the attributes and properties of your widgets
                ...
                <p>above is an example of how you can modify the attributes, class name, html tag, and visibility of your widgets, 
                ...
                <p>if you inspect the dom of your page, you will notice that when the widget above becomes invisible, it is still 
                ...
                <p>onwards to the <a href="ViewState.aspx">viewstate example</a>
