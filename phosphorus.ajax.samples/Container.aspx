            ...
            <div class="container">
                ...
                <pf:Container
                    ...
                    <pf:Literal
                        ...
                        Tag="li"
                        onclick="element_onclick">
                        second element (click me)
                    </pf:Literal>
                </pf:Container>
                <p>
                    above is a container widget containing two literal children controls.&nbsp;&nbsp;we have rendered the container with the 
                ...
                <p>
                    you can nest as many container widgets as you wish, to create the exact markup you wish for your page.&nbsp;&nbsp;this 
