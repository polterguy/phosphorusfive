    ...
    <body>
        <form id="form1" runat="server" autocomplete="off">
            <div class="container">
                ...
                <p>
                    if you look at the html markup of the page, you will notice that the markup is clean, and follows all html best practices, such 
                ...
                <h3>1. secure</h3>
                <p>
                    javascript and the web is inheritingly insecure by design, however, phosphorus.ajax seeks to fix that, by being secure by 
                    default.&nbsp;&nbsp;this means that you must explicitly choose to fuck up things in order to create insecure solutions
                </p>
                <p>
                    <em>"with phosphorus.ajax, you're safe by default"</em>
                </p>
                <h3>2. lightweight</h3>
                <p>
                    phosphorus.ajax consumes as little bandwidth and resources as possible.&nbsp;&nbsp;the javascript is tiny, the html the same, 
                ...
                <p>
                    <em>"with phosphorus.ajax, you're lightweight by default"</em>
                </p>
                <h3>3. beautiful</h3>
                <p>
                    with beauty, we don't mean falshy colors and the latest animations.don't get us wrong, you can easily create this type 
                ...
                <p>
                    <em>"with phosphorus.ajax, you are beautiful by default"</em>
                </p>
                <h3>4. flexible</h3>
                <p>
                    phosphorus.ajax is easy to extend.&nbsp;&nbsp;you can extend the server side classes, you can extend the javascript, and 
                ...
                <p>
                    <em>"with phosphorus.ajax, your creativity is your only limit"</em>
                </p>
                <h3>5. intuitive</h3>
                <p>
                    phosphorus.ajax is intuitive to use, extend and modify.&nbsp;&nbsp;both on the client side and on the server side.&nbsp;&nbsp;
                    you can easily start using phosphorus.ajax today, and be fluent in it before supper
                </p>
                <p>
                    <em>"with phosphorus.ajax, you already know everything you need to know"</em>
                </p>
            </div>
        </form>
    </body>
