    ...
    <body>
        <form id="form1" runat="server" autocomplete="off">
            <div class="container">
                ...
                <p>this sample shows you how to create a literal widget
                ...
                <pf:Literal
                    ...
                    Tag="p"
                    HasEndTag="false"
                    onclick="element_onclick">click me
                </pf:Literal>

                <p>phosphorus.ajax really has only two different types of widgets; the literal widget is for widgets with text or html content, 
                ...
                <p>this means that you can only modify the contents of a container widget through its Controls collection, and only modify the 
                   contents of a literal widget through its innerHTML property

                <p>by using the "Tag" property, and combining it with custom attributes in your widgets, you can create any html markup you wish 
                ...
                <p>onwards to the <a href="Container.aspx">container sample</a>
