...
namespace phosphorus.unittests
{
    ...
    public class Core : TestBase
    {
        ...
        /// </summary>
        [Test]
        public void LoadAssembly1 () { Loader.Instance.LoadAssembly ("pf.lambda"); }

        /// <summary>
        ///     verifies loading an assembly with extension works
        /// </summary>
        [Test]
        public void LoadAssembly2 () { Loader.Instance.LoadAssembly ("pf.lambda.dll"); }
        ...
        {
            Loader.Instance.LoadAssembly ("pf.lambda");
            Loader.Instance.LoadAssembly ("pf.lambda");
        }
        ...
        {
            Loader.Instance.LoadAssembly ("pf.lambda");
            Loader.Instance.LoadAssembly ("pf.hyperlisp");
        }
        ...
        public void ApplicationContext11 ()
        {
            ...
            Loader.Instance.UnloadAssembly ("pf.tests");
            var context = Loader.Instance.CreateApplicationContext ();
            var tmp = new Node (string.Empty, string.Empty);
