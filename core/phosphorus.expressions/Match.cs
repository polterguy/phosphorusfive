...
namespace phosphorus.expressions
{
    ...
    public class Match : IEnumerable<MatchEntity>
    {
        ...
        public MatchType TypeOfMatch { get; private set; }
        ...
        public IEnumerator<MatchEntity> GetEnumerator () { return _matchEntities.GetEnumerator (); }

        /*
         * private implementation of IEnumerable<MatchEntity>'s base interface for clarity
         */
        IEnumerator IEnumerable.GetEnumerator () { return _matchEntities.GetEnumerator (); }
    }
}