...
(function() {
    ...
    window.p5.element.prototype = {
         ...
         */
        __p5_del: function(value) {
            for (var idx = 0; idx < value.length; idx++) {
                var atr = value[idx];
                if (this["__p5_del_" + atr]) {
                    this["__p5_del_" + atr]();
                } else {
        ...
        __p5_del_selected: function() {
            this.el.selected = false;
        },


        __p5_del_checked: function() {
            this.el.checked = false;
        },


        __p5_del_class: function() {
            this.el.className = "";
        },


        __p5_del_value: function() {
            this.el.value = "";
        },


        __p5_del_style: function() {
        ...
        _raise: function(evt, options) {
            ...
            // sending request
            var body = "__p5_event=" + evt + "&__p5_widget=" + this.el.id;
