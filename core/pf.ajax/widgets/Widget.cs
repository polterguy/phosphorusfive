...
{
    /// <summary>
    ///     Abstract base class for all widgets in pf.ajax.
    /// 
    ///     This is the abstract base class for all widgets in pf.ajax, and is what allows pf.ajax to update
    ...
    ///     that pf.ajax consumes very little bandwidth. This fact combined with the fact that pf.ajax only contains ~5KB of
    ...
    public abstract class Widget : Control, IAttributeAccessor
    {
        ...
        public virtual string ElementType
        {
            ...
            set
            {
                if (value.ToLower () != value)
                    throw new ArgumentException ("pf.ajax doesn't like uppercase element names", "value");
                this ["Tag"] = value;
            }
        }
        ...
        ///     <see cref="pf.ajax.widgets.Widget.RenderingType">RenderingType</see>, to understand how this affects your rendered HTML.
        /// </summary>
