...
namespace phosphorus.applicationpool
{
    ...
    public partial class Default : AjaxPage
    {
        ...
        ///       onclick
        ///         pf.web.remove-widget:@/./"*"/_event?value</pre>
        /// 
        ///     Using [pf.web.create-widget], in combination with the other Active Events for manipulating Ajax Web Widgets, you can take 100%
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.list-widgets")]
        private void pf_web_list_widgets (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.widgets.set-info")]
        private void pf_web_widgets_set_info (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.widgets.get-info")]
        private void pf_web_widgets_get_info (ApplicationContext context, ActiveEventArgs e)
        {
            if (e.Args.Value == null || e.Args.Count == 0)
                return; // nothing to do here ...
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.widgets.remove-info")]
        private void pf_web_widgets_remove_info (ApplicationContext context, ActiveEventArgs e)
        {
            if (e.Args.Value == null || e.Args.Count == 0)
                return; // nothing to do here ...
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.widgets.list-info")]
        private void pf_web_widgets_list_info (ApplicationContext context, ActiveEventArgs e)
        {
            if (e.Args.Value == null)
                return; // nothing to do here ...
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.widgets.get-event")]
        private void pf_web_widgets_get_event (ApplicationContext context, ActiveEventArgs e)
        {
            // syntax checking
            if (e.Args.Value == null)
                return; // nothing to do here
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.widgets.set-event")]
        private void pf_web_widgets_set_event (ApplicationContext context, ActiveEventArgs e)
        {
            // syntax checking
            if (e.Args.Value == null)
                return; // nothing to do here
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.widgets.remove-event")]
        private void pf_web_widgets_remove_event (ApplicationContext context, ActiveEventArgs e)
        {
            // syntax checking
            if (e.Args.Value == null)
                return; // nothing to do here
        ...
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.widgets.list-events")]
        private void pf_web_widgets_list_events (ApplicationContext context, ActiveEventArgs e)
        {
            // looping through all widgets
            foreach (var idx in XUtil.Iterate<string> (e.Args, context)) {
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.include-javascript-file")]
        private void pf_web_include_javascript_file (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.include-stylesheet-file")]
        private void pf_web_include_stylesheet_file (ApplicationContext context, ActiveEventArgs e)
        {
            foreach (var idxFile in XUtil.Iterate<string> (e.Args, context)) {
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.set-page-title")]
        private void pf_web_set_page_title (ApplicationContext context, ActiveEventArgs e)
        {
        ...
        /// <param name="context">Application context Active Event is raised within</param>
        /// <param name="e">Parameters passed into Active Event</param>
        [ActiveEvent (Name = "pf.web.return-response-value")]
        private void pf_web_return_response_value (ApplicationContext context, ActiveEventArgs e)
        {
