...
namespace phosphorus.expressions
{
    ...
    /// 
    ///     When you use the Boolean algebraic properties of pf.lambda expressions, you often will want to group your logicals together, inside 
    ...
    ///     Boolean algebra, to create your own dimensional extraction from your pf.lambda node-set.
    /// </summary>
