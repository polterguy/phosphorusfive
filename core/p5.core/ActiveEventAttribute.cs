...
/*! \mainpage Phosphorus Five
 * 
 * Phosphorus Five is a web application platform and a web <em>"operating system"</em>, complete with everything you need. Among its 
 * core traits, is the ability to create truly Agile software, and deliver them at a fraction of the time necessary with most other 
 * alternatives. Although p5 is targeted towards web development, it is still easy and very much possible to create console apps or
 * desktop GUI apps using parts of the framework.
 *
 * <strong>Installing Phosphorus Five</strong>
 * 
 ...
 * 
 * 3. Open "phosphorus-five.sln" in either Visual Studio, Xamarin or MonoDevelop.
 * 
 ...
 * appSettings key. And that you have downloaded and extracted System42 into your "core/p5.webapp" folder.
 * 
 * <strong>Important constructs in Phosphorus Five</strong>
 * 
 * Phosphorus has some few important traits few if any other frameworks have. To understand and develop p5 apps in C#, it is crucial that
 * you understand the concepts of <see cref="p5.core.ActiveEventAttribute">Active Events</see>.
 * 
 * If you wish to develop purely in p5.lambda, you need to understand <see cref="p5.hyperlisp">Hyperlisp</see>, which is actually
 * not a programming language, but rather a file format, created as a human readable version of JSON with support for types (BSON, but readable)
 * 
 ...
 * to run the example code through the <em>"p5.lambda executor"</em> in System42, which allows you to see the output of executed p5.lambda code.
 * 
 ...
 * <em>"p5.lambda"</em> user, who exclusively wishes to use the p5.lambda parts of Phosphorus Five, which can be seen through classes such as
 * the <see cref="phosphorus.expressions.Expression">Expression</see> class, providing extensive documentation about the p5.lambda
...
namespace p5.core
{
    ...
    ///     to actually handle.
    /// 
    ///     Active Events you create, can also easily be raised from p5.lambda code. To raise the above Active Event from p5.lambda, you
    ...
    ///     functions and methods in your solution, and is the facilitator behind the entirety of Phosphorus Five, especially the "p5.lambda"
