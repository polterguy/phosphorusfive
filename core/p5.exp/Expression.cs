...
namespace p5.exp
{
    ...
    /// 
    ///     Responsible for parsing, building, and evaluating your p5.lambda expressions, according to what types of iterators
    ...
    ///     on expressions, and sub-expressions, you can probably extract any node-set you wish, from any starting p5.lambda node tree 
    ...
    ///   source:yes</pre>
    /// 
    ///     Creating C# code to do the equivalent of the above p5.lambda expression, would end up in a monstrous, recursive, multiple methods 
    ///     implementation, spanning possibly dozens, if not more than 100 lines of code. With p5.lambda expressions, it's a simple one-liner 
    ///     expression, roughly 40 characters long.
    /// 
    ///     With p5.lambda expressions, you can very often completely eliminate recursive method invocations, and in fact even conditional branching,
    ...
    ///     or retrieve. With p5.lambda expressions, you can easily for instance create a list result-set, from a relational graph object, without
    ...
    /// 
    ///     You can also convert the results of your expressions, to any of the types that there exists a [p5.hyperlisp.get-object-value.xxx]
