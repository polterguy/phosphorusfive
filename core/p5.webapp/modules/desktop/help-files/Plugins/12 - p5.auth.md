...
not recommended, it is possible to do.
...
* __[p5.auth.has-access]__ - Returns whether or not a user has access to some _"path"_ or not

**Important** - Only root accounts can modify the access object(s). The **[p5.auth.has-access]** Active
...
If you want to remove all automatically generated GUIDs for your access objects' IDs, you can pass in **[guids]**,
and set its value to boolean _"false"_.
...
And you invoke **[p5.auth.has-access]** with the following example code.
...
See the documentation for _"Peeples"_ for more information about how to create access objects in
Phosphorus Five.
